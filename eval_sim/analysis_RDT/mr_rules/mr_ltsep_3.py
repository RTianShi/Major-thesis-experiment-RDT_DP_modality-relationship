...
@register_mr_rule("MR-LTSEP-3")
def analyze_mr_ltsep_3(base_records: List[Any], mr_records: List[Any], **kwargs) -> Dict[str, Any]:
    return _analyze_ltsep3(
        base_records,
        mr_records,
        mr_id="MR-LTSEP-3",
        stop_ratio=float(kwargs.get("stop_ratio", LTSEP3_STOP_RATIO)),
    )
