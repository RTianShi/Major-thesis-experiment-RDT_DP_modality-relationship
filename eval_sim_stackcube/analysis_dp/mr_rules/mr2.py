...
MR2_SIMILARITY_THRESHOLD = 0.9
MR2_MIN_ALIGNMENT_POINTS = 4
MR2_SAMPLE_POINTS = 24
...
def _trajectory_similarity_metrics(
    ...
    *,
    ...
    if sample_count < MR2_MIN_ALIGNMENT_POINTS:
        return None
...
@register_mr_rule("MR2")
@register_mr_rule("MR-2")
@register_mr_rule("Non-Interfering-Object-Addition")
def analyze_mr2_non_interfering_object_addition(
    base_records: List[Any], mr_records: List[Any], **kwargs
) -> Dict[str, Any]:
    similarity_threshold = float(kwargs.get("similarity_threshold", MR2_SIMILARITY_THRESHOLD))
    sample_points = int(kwargs.get("sample_points", MR2_SAMPLE_POINTS))
        ...
        if analyzable:
            ...
            if metrics is None:
                ...
                if similarity < similarity_threshold:
                    violated = True
                    reasons.append("VIOLATION: Non-interfering object addition changed behavior too much")
                else:
                    reasons.append("non_interfering_object_addition_pass")
    ...
    return {
        ...
        "config": {
            ...
            "expectation": "non_interfering_object_should_not_change_trajectory_much",
        },
        "details": details,
    }
